...
//
    ...
    static func toDataBase(idx: Int) {
        ...
        let school = schoolList[idx]
        let major = majorList[idx]
        
        AuthAPIService.register(email: email, password: password, userName: userName, nickName: nickName, gender: gender, birth: birth, company: nil, job: nil, year: 0, school: school, major: major) { response in
